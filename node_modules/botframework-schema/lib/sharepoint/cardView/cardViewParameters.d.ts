 ...
 */
export declare type CardViewActionsFooterParameters = [CardButtonComponent] | [CardButtonComponent, CardButtonComponent] | undefined;
/**
 * The footer parameters for the card view. Can contain either 0 to 2 buttons or a single text input.
 */
export declare type CardViewFooterParameters = CardViewActionsFooterParameters | [CardTextInputComponent];
/**
 ...
 */
export declare type CardViewParameters = TextCardViewParameters | TextInputCardViewParameters | SearchCardViewParameters | SignInCardViewParameters;
/**
 ...
 */
export declare function BasicCardView(cardBar: CardBarComponent, header: CardTextComponent, footer?: CardViewFooterParameters): TextCardViewParameters;
/**
 ...
 */
export declare function PrimaryTextCardView(cardBar: CardBarComponent, header: CardTextComponent, body: CardTextComponent, footer?: CardViewFooterParameters): TextCardViewParameters;
/**
 ...
 */
export declare function ImageCardView(cardBar: CardBarComponent, header: CardTextComponent, image: CardImage, footer?: CardViewFooterParameters): TextCardViewParameters;
/**
 ...
 */
export declare function TextInputCardView(cardBar: CardBarComponent, header: CardTextComponent, body: CardTextInputComponent, footer?: CardViewActionsFooterParameters): TextInputCardViewParameters;
/**
 ...
 */
export declare function SearchCardView(cardBar: CardBarComponent, header: CardTextComponent, body: CardSearchBoxComponent, footer: CardSearchFooterComponent): SearchCardViewParameters;
/**
 ...
 */
export declare function SignInCardView(cardBar: CardBarComponent, header: CardTextComponent, body: CardTextComponent, footer: CardButtonComponent): SignInCardViewParameters;
//# sourceMappingURL=cardViewParameters.d.ts.map