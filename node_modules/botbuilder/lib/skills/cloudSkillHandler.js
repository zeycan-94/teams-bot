...
exports.CloudSkillHandler = void 0;
const cloudChannelServiceHandler_1 = require("../cloudChannelServiceHandler");
const skillHandlerImpl_1 = require("./skillHandlerImpl");
const botbuilder_core_1 = require("botbuilder-core");
/**
 * A Bot Framework Handler for skills.
 */
class CloudSkillHandler extends cloudChannelServiceHandler_1.CloudChannelServiceHandler {
    /**
     ...
     */
    constructor(adapter, logic, conversationIdFactory, auth) {
        super(auth);
        /**
        ...
        this.inner = new skillHandlerImpl_1.SkillHandlerImpl(this.SkillConversationReferenceKey, adapter, logic, conversationIdFactory, () => auth.getOriginatingAudience());
    }
    /**
     ...
     */
    onGetConversationMember(claimsIdentity, userId, conversationId) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.inner.onGetMember(claimsIdentity, userId, conversationId);
        });
    }
}
exports.CloudSkillHandler = CloudSkillHandler;
//# sourceMappingURL=cloudSkillHandler.js.map