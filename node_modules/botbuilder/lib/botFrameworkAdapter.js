...
class BotFrameworkAdapter extends botbuilder_core_1.BotAdapter {
    ...
    createConnectorClientInternal(serviceUrl, credentials) {
        const options = Object.assign({}, this.settings.clientOptions);
        if (BotFrameworkAdapter.isStreamingServiceUrl(serviceUrl)) {
            ...
            options.httpClient = new streaming_1.StreamingHttpClient(this.streamingServer);
        }
        ...
        options.userAgent = `${exports.USER_AGENT} ${userAgent !== null && userAgent !== void 0 ? userAgent : ''}`;
        ...
        return new botframework_connector_1.ConnectorClient(credentials, options);
    }
