...
class CustomAuthAccountData {
    ...
    async signOut() {
        try {
            ...
            this.logger.verbose("17l5fh", this.correlationId);
            await this.cacheClient.logout({
                correlationId: this.correlationId,
                account: currentAccount,
            });
            this.logger.verbose("16o7ps", this.correlationId);
            return new SignOutResult();
        }
        catch (error) {
            this.logger.errorPii("19tou7", this.correlationId);
    ...
    async getAccessToken(accessTokenRetrievalInputs) {
        try {
            ...
            this.logger.verbose("0jrcu2", this.correlationId);
            const currentAccount = this.cacheClient.getCurrentAccount(this.account.username);
            if (!currentAccount) {
                throw new NoCachedAccountFoundError(this.correlationId);
            }
            this.logger.verbose("108lch", this.correlationId);
            ...
            this.logger.verbose("1w15hv", this.correlationId);
            return new GetAccessTokenResult(result);
        }
        catch (error) {
            this.logger.error("0yfud8", this.correlationId);
...
class FetchHttpClient {
    ...
    async sendAsync(url, options) {
        ...
        const correlationId = headers?.[CLIENT_REQUEST_ID] || "";
        try {
            this.logger.verbosePii("17dhbs", correlationId);
            const startTime = performance.now();
            const response = await fetch(url, options);
            const endTime = performance.now();
            this.logger.verbosePii("1egykc", correlationId);
            return response;
        }
        catch (e) {
            this.logger.errorPii("0ye3lm", correlationId);
...
class SignInState extends AuthFlowActionRequiredStateBase {
    ...
    handleSignInResult(result, scopes) {
        ...
        if (result.type === SIGN_IN_COMPLETED_RESULT_TYPE) {
            ...
            this.stateParameters.logger.verbose("1wz8ns", correlationId);
            ...
            this.stateParameters.logger.verbose("0fiacy", correlationId);
            return {
            ...
            this.stateParameters.logger.verbose("0ql59l", correlationId);
            return {
...
class SignInCodeRequiredState extends SignInState {
    ...
    async submitCode(code) {
        try {
            ...
            this.stateParameters.logger.verbose("0gosr6", this.stateParameters.correlationId);
            const submitCodeResult = await this.stateParameters.signInClient.submitCode(submitCodeParams);
            this.stateParameters.logger.verbose("14jm6w", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii("05uiw3", this.stateParameters.correlationId);
    ...
    async resendCode() {
        try {
            ...
            this.stateParameters.logger.verbose("0g09c3", this.stateParameters.correlationId);
            const result = await this.stateParameters.signInClient.resendCode(submitCodeParams);
            this.stateParameters.logger.verbose("03fy3t", this.stateParameters.correlationId);
...
class SignInPasswordRequiredState extends SignInState {
    ...
    async submitPassword(password) {
        try {
            ...
            this.stateParameters.logger.verbose("1dm2kj", this.stateParameters.correlationId);
            const submitPasswordResult = await this.stateParameters.signInClient.submitPassword(submitPasswordParams);
            this.stateParameters.logger.verbose("1e0esa", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii("0jy3yf", this.stateParameters.correlationId);
...
class SignInContinuationState extends SignInState {
    ...
    async signIn(signInWithContinuationTokenInputs) {
        try {
            ...
            this.stateParameters.logger.verbose("1lhjo6", this.stateParameters.correlationId);
            const signInResult = await this.stateParameters.signInClient.signInWithContinuationToken(continuationTokenParams);
            this.stateParameters.logger.verbose("0su211", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii("03tyr8", this.stateParameters.correlationId);
...
class ResetPasswordCodeRequiredState extends ResetPasswordState {
    ...
    async submitCode(code) {
        try {
            this.ensureCodeIsValid(code, this.stateParameters.codeLength);
            this.stateParameters.logger.verbose("0eno3c", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.verbose("1pdlyx", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii("1wtelk", this.stateParameters.correlationId);
    ...
    async resendCode() {
        try {
            this.stateParameters.logger.verbose("13fdb0", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.verbose("01cakn", this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii("1vyfic", this.stateParameters.correlationId);
