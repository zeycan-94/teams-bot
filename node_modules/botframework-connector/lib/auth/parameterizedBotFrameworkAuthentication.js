...
class ParameterizedBotFrameworkAuthentication extends botFrameworkAuthentication_1.BotFrameworkAuthentication {
    ...
    authenticateChannelRequest(authHeader) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.credentialsFactory.isAuthenticationDisabled()) {
    ...
    SkillValidation_authenticateChannelToken(authHeader, channelId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokenExtractor = new jwtTokenExtractor_1.JwtTokenExtractor(verifyOptions, this.toBotFromEmulatorOpenIdMetadataUrl, authenticationConstants_1.AuthenticationConstants.AllowedSigningAlgorithms, (_b = this.connectorClientOptions) === null || _b === void 0 ? void 0 : _b.proxySettings, (_c = this.connectorClientOptions) === null || _c === void 0 ? void 0 : _c.tokenRefreshInterval);
    ...
    ChannelValidation_authenticateChannelToken(authHeader, serviceUrl, channelId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokenExtractor = new jwtTokenExtractor_1.JwtTokenExtractor(tokenValidationParameters, this.toBotFromChannelOpenIdMetadataUrl, authenticationConstants_1.AuthenticationConstants.AllowedSigningAlgorithms, (_a = this.connectorClientOptions) === null || _a === void 0 ? void 0 : _a.proxySettings, (_b = this.connectorClientOptions) === null || _b === void 0 ? void 0 : _b.tokenRefreshInterval);
            const identity = yield tokenExtractor.getIdentityFromAuthHeader(authHeader, channelId, this.authConfiguration.requiredEndorsements);
