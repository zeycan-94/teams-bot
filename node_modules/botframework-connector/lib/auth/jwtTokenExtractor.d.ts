...
export declare class JwtTokenExtractor {
     ...
     */
    constructor(tokenValidationParameters: VerifyOptions, metadataUrl: string, allowedSigningAlgorithms: string[] | Algorithm[], proxySettings?: ProxySettings, tokenRefreshInterval?: number);
