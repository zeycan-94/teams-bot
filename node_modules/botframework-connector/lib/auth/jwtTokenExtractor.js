...
class JwtTokenExtractor {
     ...
     */
    constructor(tokenValidationParameters, metadataUrl, allowedSigningAlgorithms, proxySettings, tokenRefreshInterval) {
        ...
        this.openIdMetadata = JwtTokenExtractor.getOrAddOpenIdMetadata(metadataUrl, proxySettings, tokenRefreshInterval);
    }
    static getOrAddOpenIdMetadata(metadataUrl, proxySettings, tokenRefreshInterval) {
        let metadata = this.openIdMetadataCache.get(metadataUrl);
        if (!metadata) {
            metadata = new openIdMetadata_1.OpenIdMetadata(metadataUrl, proxySettings, tokenRefreshInterval);
